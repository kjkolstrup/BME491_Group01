  ...
  */
  ...
  switch (currentExercise) {
    case 1:
      ...
      if (thumbForce > COMPLETE_THRESHOLD && flex1 < 400 && !exerciseComplete) {
        // Exercise completed
    ...
    case 2:
      ...
      // Check if exercise is completed
      if (thumbForce > COMPLETE_THRESHOLD && flex2 < 400 && !exerciseComplete) {
        // Exercise completed
        exerciseComplete = true;
        successCount++;
    ...
    case 3:
      ...
      // Check if exercise is completed
      if (thumbForce > COMPLETE_THRESHOLD && flex3 < 400 && !exerciseComplete) {
        // Exercise completed
        exerciseComplete = true;
        successCount++;
    ...
    case 4:
      ...
      // Check if exercise is completed
      if (thumbForce > COMPLETE_THRESHOLD && flex4 < 400 && !exerciseComplete) {
        // Exercise completed
        exerciseComplete = true;
        successCount++;
