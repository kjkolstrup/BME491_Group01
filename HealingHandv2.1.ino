...
int successCount = 0;  // Counter for successful exercise
...
// Add these helper functions for the rehabilitation mode
...
// Function to display a simple finger diagram
...
// Function to display current sensor values
...
// Function to finish rehab mode and show results
